...
class MySQLConnection:
    ...
    def get_connection(self, db_create=True):
        engine = sqlalchemy.create_engine(
            f'mysql+pymysql://{self.user}:{self.password}@{self.host}:3306/{self.db_name}' if db_create else "",
            encoding='utf8'
        )
    ...
    def connect(self):
        ...
        return self.get_connection(db_create=True)
